...
<body>
    ...
    <div class="Galimg"><img src="Media/Mask Group 27.png" alt="img">
    </div>

    <div class="galtxt">
        <p class="galhead">Gallery</p>
        <br>
        <p class="galdes">THE SKY IS THE ULTIMATE GALLERY JUST ABOVE US.</p>
    </div>

    <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>

    <div class="imggal">
        <img class="img49" src="Media/Gallery/Mask Group 49.png" alt="img">
        <img class="img50" src="Media/Gallery/Mask Group 50.png" alt="img">
        <img class="img51" src="Media/Gallery/Mask Group 51.png" alt="img">
        <img class="img52" src="Media/Gallery/Mask Group 52.png" alt="img">
        <img class="img53" src="Media/Gallery/Mask Group 53.png" alt="img">
        <br><br>
        <img class="img54" src="Media/Gallery/Mask Group 54.png" alt="img">
        <img class="img55" src="Media/Gallery/Mask Group 55.png" alt="img">
        <img class="img56" src="Media/Gallery/Mask Group 56.png" alt="img">
        <br><br>
        <img class="img58" src="Media/Gallery/Mask Group 58.png" alt="img">
        <img class="img57" src="Media/Gallery/Mask Group 57.png" alt="img">
    ...
    <div class="newsletterbg">
        <img src="Media/Mask Group 17.png" alt="bg">
    </div>
