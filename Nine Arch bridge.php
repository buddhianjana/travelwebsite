...
<head>
    ...
    <link rel="stylesheet" href="CSS/Nine Arch bridge.css">
...
<body>
    ...
    <div><img class="bgimg" src="Media/placesimg/Group 66.png" alt="img">
    </div>

    <div class="bgtxt">
        <p class="bghead">Nine Arch bridge</p>
        <br>
        <p class="bgdes">Bridge in the Sky, is a viaduct bridge in Sri Lanka.</p>
    </div>

    <br><br><br>

    <div class="contentimgcol">
        <img class="imgcol" src="Media/placesimg/Group 67.png" alt="img">
    </div>

    <div class="contenttxt">
        <p class="phratxt">The Nine Arch Bridge also called the Bridge in the Sky, <br> is a viaduct bridge in Sri Lanka. It is one of the best examples
            <br> of colonial-era railway construction in the country. The construction <br> of the bridge is generally attributed to a local Ceylonese
            <br> builder, P. K. Appuhami, in consultation with British engineers.<br> The chief designer and project manager of the 'upcountry railway line
            <br> of Ceylon' project was D. J. Wimalasurendra, a distinguished <br> Ceylonese engineer and inventor. The designer of the viaduct was Harold
            <br> Cuthbert Marwood of Railway Construction Department of Ceylon <br> Government Railway. The 1923 report titled "Construction of a
            <br> Concrete Railway Viaduct in Ceylon" published by the Engineering <br> Association of Ceylon has details of all the records
            <br> including the plans and drawings.It is located in Demodara, <br> between Ella and Demodara railway stations. The surrounding area
            <br> has seen a steady increase of tourism due to the bridge's <br> architectural ingenuity and the profuse greenery in the nearby hillsides.
            <br><br> <br> Popular rumours suggest that when construction work commenced on the bridge, the Great War began between the empires of Europe
            <br> and the steel assigned for this site was reallocated to Britain's War related projects at the battlefront. As a result, the work came to a standstill, leading the locals to build the bridge with stone bricks and cement, but without steel.
